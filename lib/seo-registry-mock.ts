...
export const mockSeoPages: SeoLandingPage[] = [
  // TYPE 1: SERVICE + LOCATION
  {
    ...
    canonicalUrl: 'https://tfts.co.uk/drone-services/london/drone-roof-inspections',
    ...
    seoTitle: 'Drone Roof Inspections London | TFTS Drone',
  ...
  },
  {
    ...
    canonicalUrl: 'https://tfts.co.uk/drone-services/sheffield/stockpile-volume-surveys',
  ...
  // TYPE 2: SERVICE + SECTOR
  {
    ...
    canonicalUrl: 'https://tfts.co.uk/industries/facilities-management/drone-roof-inspections',
    parentService: 'roof-inspections',
    ...
    status: 'Published',
    indexabilityStatus: 'Index',
    seoTitle: 'Drone Roof Inspections for Facilities Management | TFTS Drone',
  ...
  // TYPE 3: SERVICE + LOCATION + SECTOR
  {
    ...
    canonicalUrl: 'https://tfts.co.uk/seo/london/facilities-management/drone-roof-inspections',
    parentService: 'roof-inspections',
    parentLocation: 'london',
    parentSector: 'facilities-management',
  ...
  // TYPE 4: OUTCOME
  {
    ...
    canonicalUrl: 'https://tfts.co.uk/outcomes/drone-evidence-for-insurance-claims',
    ...
    status: 'Published',
    indexabilityStatus: 'Index',
    seoTitle: 'Drone Evidence for Insurance Claims | TFTS Drone',
  ...
  // TYPE 5: COST
  {
    ...
    canonicalUrl: 'https://tfts.co.uk/costs/drone-roof-inspection-cost-uk',
  ...
  // TYPE 6: COMPARISON
  {
    ...
    canonicalUrl: 'https://tfts.co.uk/compare/drone-inspection-vs-scaffolding',
  ...
  // TYPE 7: SOLUTION
  {
    ...
    canonicalUrl: 'https://tfts.co.uk/solutions/inspect-roof-without-scaffolding',
    ...
    status: 'Published',
    indexabilityStatus: 'Index',
    seoTitle: 'How to Inspect a Roof Without Scaffolding | TFTS Drone',
