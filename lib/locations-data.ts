...
export const locationsData: LocationData[] = [
  ...
  { 
    ...
    localRelevance: 'TFTS Drone provides nationwide project support, multi-site portfolio inspections, and repeat monitoring for national clients. We manage operations across property, construction, and FM portfolios with centralized planning and consistent delivery.',
