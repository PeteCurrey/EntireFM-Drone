...
export const metadata: Metadata = {
  title: 'Drone Survey Pricing Guidance | Project Investment Factors | TFTS Drone',
...
export default function PricingGuidancePage() {
  const costFactors = [
    ...
    },
    {
      ...
      body: 'Processing raw imagery into orthomosaic maps, 3D models, TFTS 3Ds or detailed condition reports adds value and requires specialist time.',
      impact: 'High'
    },
    {
      ...
      <section className="py-32 px-10 md:px-20 bg-mid border-y border-white/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="font-body text-xl text-white/50 leading-relaxed uppercase tracking-widest font-light mb-12">
            In the commercial drone sector, the lowest price often indicates a lack of proper planning, insufficient insurance, poor data quality, or a lack of understanding of the required technical output. TFTS Drone prices projects based on the operational standard required to deliver professional results.
          </p>
        ...
        <div className="max-w-[1000px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left max-w-4xl mx-auto">
             ...
             <div className="p-8 bg-dark text-white border border-white/10">
                <h4 className="font-display text-xl mb-4 uppercase tracking-widest text-accent">What TFTS Drone Delivers:</h4>
                <ul className="space-y-3">
