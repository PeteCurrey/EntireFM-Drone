...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const seoTitles: Record<string, string> = {
    'commercial-drone-inspection-buyers-guide': "Commercial Drone Inspection Buyer's Guide | TFTS Drone",
    'drone-roof-inspection-checklist': 'Drone Roof Inspection Checklist | TFTS Drone',
    'facilities-manager-drone-survey-guide': "Facilities Manager's Drone Survey Guide | TFTS Drone",
    'construction-progress-monitoring-template': 'Construction Progress Monitoring Template | TFTS Drone',
    'insurance-evidence-drone-capture-checklist': 'Insurance Evidence Drone Capture Checklist | TFTS Drone',
    'gaussian-splat-vs-photogrammetry-guide': 'TFTS 3D vs Photogrammetry Guide | TFTS Drone',
    'drone-survey-cost-guide': 'Drone Survey Cost Guide | TFTS Drone',
  }

  const seoDescriptions: Record<string, string> = {
    'commercial-drone-inspection-buyers-guide': "Download TFTS Drone's commercial drone inspection buyer's guide for planning, scoping and evaluating drone inspections for roofs, buildings and access-restricted assets.",
    'drone-roof-inspection-checklist': "Download TFTS Drone's drone roof inspection checklist for planning commercial roof, gutter, drainage and high-level building inspections.",
    'facilities-manager-drone-survey-guide': "Download TFTS Drone's FM drone survey guide for planned maintenance, contractor scoping, thermal imaging and multi-site portfolio records.",
    'construction-progress-monitoring-template': "Download TFTS Drone's construction progress monitoring template for repeat drone capture, milestone records and stakeholder-ready site updates.",
    'insurance-evidence-drone-capture-checklist': "Download TFTS Drone's insurance evidence drone capture checklist for planning aerial evidence after storm, fire, flood or access-restricted property incidents.",
    'gaussian-splat-vs-photogrammetry-guide': "Download TFTS Drone's guide comparing TFTS 3Ds, photogrammetry, LiDAR and 360 panoramas for commercial site visualisation and measurement workflows.",
    'drone-survey-cost-guide': "Download TFTS Drone's drone survey cost guide covering the factors that affect inspection, mapping and aerial data capture project costs.",
  }

  return {
    title: seoTitles[slug] || `${asset.title} | TFTS Drone`,
