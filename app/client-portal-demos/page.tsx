...
const DEMO_PORTALS = [
  ...
  {
    slug: 'gaussian-splat',
    title: 'TFTS 3D / 3D Capture Demo Portal',
    desc: 'A sample immersive capture portal showing TFTS 3D screenshots, flythrough video, 3D visualisation assets and related deliverables.',
    icon: Box,
...
const FAQS = [
  ...
  {
    question: "Can TFTS Drone provide a portal for my project?",
  ...
  },
  {
    ...
    answer: "A portal can include project summaries, image galleries, annotated evidence, PDF reports, maps, videos, TFTS 3D previews, download links and next-step records depending on the project."
  },
  {
      ...
      <header className="relative py-48 px-10 md:px-20 bg-mid overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-10 max-w-[1200px]">
          ...
          <p className="font-body text-xl md:text-2xl text-white/60 leading-relaxed mb-12 max-w-[900px] uppercase tracking-widest font-light">
            See how TFTS Drone can organise drone project outputs into clear client-facing portals — from roof inspections and construction progress records to survey data, insurance evidence, aerial media and TFTS 3D visualisation.
          </p>
      ...
      <section className="py-32 px-10 md:px-20 bg-dark border-b border-white/5">
        <div className="max-w-[1000px] mx-auto text-center">
          ...
          <p className="font-body text-xl text-white/40 uppercase tracking-widest leading-relaxed font-light mb-12">
            Commercial drone work should not end with a random folder of files. TFTS Drone can organise project outputs into structured client-facing portals so teams can review imagery, download reports, inspect evidence, track progress and share deliverables with stakeholders.
          </p>
      ...
      <section className="py-40 px-10 md:px-20 text-center bg-dark">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="font-body text-xl text-white/50 uppercase tracking-widest leading-relaxed mb-16 max-w-2xl mx-auto font-light">
            Tell us about your project requirements. TFTS Drone will structure the delivery format around your specific project outputs.
          </p>
