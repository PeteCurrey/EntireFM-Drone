...
export const metadata: Metadata = {
  title: 'TFTS 3D & 3D Capture Portal Demo | TFTS Drone',
  description: 'View a representative immersive capture portal showing TFTS 3D screenshots, flythrough video, 3D visualisation assets and related deliverables.',
}
...
export default function GaussianSplatPortalDemo() {
  return (
    <PortalLayout
      slug="gaussian-splat"
      title="TFTS 3D and 3D Capture Portal Demo"
      subtitle="Representative delivery portal for TFTS 3D visualisation, 3D capture assets, flythrough videos, screenshots and immersive site records."
      projectTitle="Immersive 3D Site Capture — Demo Portal"
      serviceCategory="TFTS 3D Capture / 3D Visualisation"
      ...
      deliverables={[
        { title: "TFTS 3D Visualisation", type: "3d", desc: "A photorealistic, interactive 3D record of the site environment.", status: "Preview", actionLabel: "Preview Viewer" },
        ...
        { title: "Immersive Flythrough Video", type: "video", desc: "A cinematic video tour created from the TFTS 3D data.", status: "Sample" },
      ...
      relatedLinks={[
        { title: "TFTS 3D Capture Service", href: "/services/tfts-3d" },
